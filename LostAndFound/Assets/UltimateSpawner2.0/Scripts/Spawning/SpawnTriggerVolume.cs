...
namespace UltimateSpawner.Spawning
{
    ...
    {
        // Private
        private List<Collider> thisColliders3D = null;
        private List<Collider2D> thisColliders2D = null;
        ...
        public override void Awake()
        {
            ...
            thisColliders2D = new List<Collider2D>(GetComponents<Collider2D>());
            thisColliders3D = new List<Collider>(GetComponents<Collider>());
        }
